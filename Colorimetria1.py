...
class InterfazGrafica:
    ...
    def Cambiar_color(self, imagen, color, umbral, titulo):
        ...
        for i in range(3):
            np_img[pixels_a_cambiar, i] = nuevo_color[i] * ((nuevo_color[i]) / 255)
    ...
    def mostrar_imagenes_2(self):
        ...
        def SeleccionPaleta(ColoresSeleccionados):
            SubtonoFrio = ['0.jpg', '1.jpg', '2.jpg']
            SubtonoCalido = ['3.jpg', '4.jpg', '5.jpg']

            ConteoFrio = sum(1 for color in ColoresSeleccionados if color in SubtonoFrio)
            ConteoCalido = sum(1 for color in ColoresSeleccionados if color in SubtonoCalido)

            if ConteoFrio > ConteoCalido:
                return 'Su subtono va con los colores Frio'
            elif ConteoCalido > ConteoFrio:
                return 'Su subtono va con los colores Calido'
            else:
                return 'Su subtono va con Ambos tipos colores'
        ...
        def on_button_click(event):
            ...
            print(SeleccionPaleta(self.imagenes_seleccionadas))
